...
**Output:** `dist\windows\arduboy-emu-0.8.1-setup-x64.exe`
...
**Output:** `dist\windows\arduboy-emu-0.8.1-x64.msi`
...
**Output:**
- `dist/linux/arduboy-emu_0.8.1_amd64.deb`
- `dist/linux/arduboy-emu-0.8.1-1.x86_64.rpm`

**Install:**
```bash
sudo dpkg -i dist/linux/arduboy-emu_0.8.1_amd64.deb     # Debian/Ubuntu
sudo rpm -i dist/linux/arduboy-emu-0.8.1-1.x86_64.rpm   # Fedora/RHEL
```
...
**Output:**
- `dist/macos/ArduboyEmulator-0.8.1.pkg` — Standard macOS installer
- `dist/macos/ArduboyEmulator-0.8.1.dmg` — Drag-and-drop disk image
